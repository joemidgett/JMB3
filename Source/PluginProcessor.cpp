...
void JMB3AudioProcessor::updateState()
{
...
void JMB3AudioProcessor::splitBands(const juce::AudioBuffer<float>& inputBuffer)
{
...
void JMB3AudioProcessor::processBlock(juce::AudioBuffer<float>& buffer,
